...
namespace EHRM.Web.Controllers
{
    public class LeaveController : Controller
    {
        ...
        public LeaveController(ILeaveTypes leave)
        {
        ...
        public async Task<IActionResult> GetLeaveDetails()
        {
            ...
            int empId = Convert.ToInt32(userDetails.userId); // This will override the method parameter if needed

            // Fetch leave data based on EmpId
            var leaveData = await _leave.GetLeaveDataByEmpId(empId);

            // Return leave data as JSON
        ...
        public async Task<IActionResult> SubmitLeaveStatus(LeaveStatusViewModel model)
        {
            ...
            var result = await _leave.LeaveStatusAsync(model);
            ...
            else
            {
                ...
                // Always return a redirect in case of failure
