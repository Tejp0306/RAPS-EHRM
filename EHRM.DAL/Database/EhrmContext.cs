...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=191.101.0.53;Database=EHRM;User Id=EHRMAdmin;Password=9YeCsU3QGQp2Mnxebcmj===;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AcknowledgementForm>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Acknowle__3214EC07C5E2B970");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__AddressD__091C2AFB003A0C3B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetsDb__3214EC07A044020F");
        ...
        {
            entity.HasKey(e => e.BankId).HasName("PK__BankDeta__AA08CB13C7D3FDCF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BGVForm__3214EC0792C8780E");

            entity.ToTable("BGVForm");

            entity.HasIndex(e => e.EmpId, "UQ__BGVForm__AF2DBB986CA0A1A2").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ClientPr__3214EC0794A95542");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Declarat__3214EC077F68F0E3");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__Dependen__9BC67CF18C768949");
        ...
        {
            entity.HasKey(e => e.EducationId).HasName("PK__Educatio__4BBE3805B83523A6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__EmpType__3214EC072942401B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC275E31A6A4");

            entity.HasIndex(e => e.EmailAddress, "UQ__Employee__49A1474064B1E51A").IsUnique();

            entity.HasIndex(e => e.LoginId, "UQ__Employee__4DDA2839CA388B74").IsUnique();

            entity.HasIndex(e => e.AadharNumber, "UQ__Employee__5003EE65E3060BB6").IsUnique();

            entity.HasIndex(e => e.EmpId, "UQ__Employee__AF2DBB98AAACD71D").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC070ACC3C8E");

            entity.ToTable("EmployeesCred");

            entity.HasIndex(e => e.EmpId, "UQ__Employee__AF2DBB9807DC2EB8").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC070E7EAA10");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employem__3214EC07518C4F17");
        ...
        {
            entity.HasKey(e => e.ExitId).HasName("PK__ExitDeta__26D64EB871B9D54D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ExitInte__3213E83FC26579CA");
        ...
        {
            entity.HasKey(e => e.FamilyId).HasName("PK__FamilyDe__41D82F6B5A7408FE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Holiday__3214EC076481B7D0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LeaveBal__3214EC07ABACFAC6");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__LeavePol__2E1339A4CE608DF4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LeaveSta__3213E83FE62492C9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Leavetyp__3213E83F60073A25");
        ...
        {
            entity.HasKey(e => e.EmergencyId).HasName("PK__MasterEm__7B5544D32462D7DD");
        ...
        {
            entity.HasKey(e => e.EmploymentId).HasName("PK__MasterPr__FDC872B6E7C1377B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__NonDiscl__3214EC0768BB60E9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__NoticeBo__3214EC079DF03944");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Previous__3214EC07035209FF");
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__Probatio__0DC06F8C31C10329");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Qualific__3214EC073279DCD7");
        ...
        {
            entity.HasKey(e => e.ReportingId).HasName("PK__Reportin__D0C742CC273FD4D8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Resignat__3214EC07EFDC0A0A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Roles__3214EC07ED6012FE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Salary__3214EC07516A05D4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SubMenu__3214EC07BF869599");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Team__3214EC071C6D9ECC");
        ...
        {
            entity.HasKey(e => e.DocumentId).HasName("PK__UserDocu__1ABEEF6FAA41AECB");
        ...
        {
            entity.HasKey(e => e.EmploymentId).HasName("PK__WorkExpe__FDC872B60146225E");
